      ...
      <section className="relative bg-dark-soft px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-quicksand font-semibold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left">
              Get trends delivered to your inbox weekly.
            </h2>
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              <input
                type="text"
                className="px-4 py-3 w-full placeholder:text-dark-light"
                placeholder="Your Email"
              />
              <button className="px-4 py-3 w-full bg-primary text-white font-thin md:w-fit md:whitespace-nowrap">
                Get started
              </button>
            </div>
          ...
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative">
              <div className="w-1/2 h-1/2 bg-[#f0e3c0] rounded-lg absolute top-[10%] -right-[8%]" />
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                ...
                />
                <div className="p-5">
                  <h2 className="font-quicksand font-semibold text-xl text-dark-soft md:text-2xl lg:text-[28px]">
                    Future of Fashion
                  </h2>
                  <p className="text-dark-light mt-3 text-sm md:text-lg">
                   Runway Fashion to the Streets
                  </p>
                </div>
              </div>
            </div>
